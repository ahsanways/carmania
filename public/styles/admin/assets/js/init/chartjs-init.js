     ...
     $.ajax({
        ...
        success: function( data ) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < 12; j++) {
                     if(months[j] == data[i]['month']){
                        total_monthly[j]=data[i]['total'];
                        // total_monthly.push(data[i]['total']);
                     }
                 }
            }
        }
...
function getYearlyReport() {
    $.ajaxSetup({
     ...
     $.ajax({
        ...
        success: function( data ) {
            for (var i = 0; i < data.length; i++) { 
              total_yearly.push(data[i]['total']);
...
function createCharts(){
    ...
    //     type: 'line',
    //     data: {
    //         labels: [ "2012", "2013", "2014", "2015", "2016", "2017", "2018","2019","2020","2018","2019","2020"],
    //         type: 'line',
    //         defaultFontFamily: 'Montserrat',
    //         datasets: [ {
    //             data: [ 0, 7, 3, 5, 2, 8, 6 ,2 ,8 ,11,2,4],
    //             label: "Expense",
    ...
    //                 },
    //                 {
    //             data: [ 0, 6, 3, 4, 3, 7, 10, 14 ,19,6,3,21],
    //             label: "Profit",
