...
<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="col-md-8">
             <form method="POST" action="{{ route('buyerrequest.store') }}" enctype="multipart/form-data">
            ...
            <!-- Animated -->
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><strong>Post your Request Details</strong></div>
                        <div class="card-body card-block">
                            <div class="form-group">
                                <label for="name" class=" form-control-label">Name/Company/version</label><input type="text" name="name" id="vehicle_no" placeholder="Eg. Toyota Corolla XLI 2016" class="form-control" required>
                            </div>
                            
                            <div class="form-group"><label for="select" class=" form-control-label">Select Type</label>
                            ...
                            <div class="form-group">
                                <label for="budget" class=" form-control-label">Budget</label><input type ="number" name="budget" id="budget" min="0" placeholder="Enter your budget" class="form-control" required>
                            </div>
