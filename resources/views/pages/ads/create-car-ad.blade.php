...
<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Animated -->
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><strong>Post your Car's Information</strong></div>
                        <div class="card-body card-block">
                            <div class="form-group">
                                <label for="name" class=" form-control-label">Car Name/Company/version</label><input type="text" name="name" id="vehicle_no" placeholder="Eg. Toyota Corolla XLI" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="color" class=" form-control-label">Enter Color</label><input type="text" name="color" id="color" placeholder="Eg. Black" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check-inline">
                                  <label class="form-check-label" for="radio1">
                                    <input type="radio" class="form-check-input" id="radio1" name="transmission" value="Manual" checked>Manual
                                  </label>
                                </div>
                                <div class="form-check-inline">
                                  <label class="form-check-label" for="radio2">
                                    <input type="radio" class="form-check-input" id="radio2" name="transmission" value="Automatic">Automatic
                                  </label>
                                </div>
                            </div>
                            <div class="form-group">
