...
<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Animated -->
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><strong>Edit your Bike's Information</strong></div>
                        <div class="card-body card-block">
                            <div class="form-group">
                                <label for="name" class=" form-control-label">Bike Name/Company/version</label><input type="text" name="name" value="{{ $ad->product->name }}" id="vehicle_no" placeholder="Eg. Honda CD 70" class="form-control" required>
                            </div>
