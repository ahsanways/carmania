...
<div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Animated -->
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><strong>Edit your Autopart's Information</strong></div>
                        <div class="card-body card-block">
                            <div class="form-group">
                                <label for="name" class=" form-control-label">Name/Company (Any Additional Info)</label><input type="text" name="name" value="{{ $ad->product->name }}" id="vehicle_no" placeholder="Eg. Corolla XLI Tyres" class="form-control" required>
                            </div>
